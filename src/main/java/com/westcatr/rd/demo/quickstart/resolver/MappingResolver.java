package com.westcatr.rd.demo.quickstart.resolver;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.StrUtil;
import com.westcatr.rd.demo.quickstart.annotation.Mapping;
import com.westcatr.rd.demo.quickstart.util.SpringUtils;
 ...
 */
@Slf4j
public class MappingResolver<V, D> {

    public V mapping(D d, Class<V> vClass) {
        V v = create(vClass);
    ...
    private void setValue(Mapping annotation, V v, Object invoke, Map<String, Field> vFieldMap, Field field) throws IllegalAccessException {
    ...
    private Class<?>[] getClassArray(Object value, String[] params, Map<String, Field> dFieldMap){
    ...
    private Object[] getValueArray(Object value, String[] params, Map<String, Field> dFieldMap, D d) throws IllegalAccessException {
    ...
    private Class<?> getClass(String param, Object value, Map<String, Field> dFieldMap){
        if ("$$".equals(param)){
    ...
    private Object getObject(String param, Object value, Map<String, Field> dFieldMap, D d) throws IllegalAccessException {
        if ("$$".equals(param)){
            return value;
        }else if (param.startsWith("$")){
            Field field = dFieldMap.get(StrUtil.removePrefix(param, "$"));
    ...
    private V create(Class<V> vClass){
        try {
